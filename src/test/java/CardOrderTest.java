...
public class CardOrderTest {
    ...
    public void shouldSendForm() {
        ...
        feedbackFormName.findElement(By.className("input__control")).sendKeys("Иван Петров");
        WebElement feedbackFormPhone = driver.findElement(By.cssSelector("[data-test-id='phone']"));
        feedbackFormPhone.findElement(By.className("input__control")).sendKeys("+79090000000");
